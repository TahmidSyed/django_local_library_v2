...
#Challenge Yourself - Model for Language
class Language(models.Model):
    """
    Model representing language (e.g. English, French).
    """
...
class Book(models.Model):
    ...
    #Challenge Yourself - incorporating model into book
